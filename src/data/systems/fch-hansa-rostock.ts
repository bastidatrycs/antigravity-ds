...
export const fchHansaRostockSystem: DesignSystem = {
  ...
  colorGroupDescriptions: {
    'Brand':    'FCH-Blau (#0080C9) as the dominant brand color — headers, headings, and primary CTAs. Navy (#143A77) as a dark depth accent in headers and gradients. Club Red (#E52721) for specific hero moments.',
  ...
  colors: [
    ...
    { token: 'brand-red',       display: 'red',       hex: '#E52721', role: 'Club Red · Red Button Variant',              group: 'Brand' },
    // Surface
    ...
    { token: 'semantic-error',   display: 'error',    hex: '#E52721', role: 'Errors · Destructive Actions',               group: 'Semantic' },
